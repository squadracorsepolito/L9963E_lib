    ...
    struct {
        ...
        struct {
            uint32_t GPIO6_OPEN : 1, GPIO7_OPEN : 1, GPIO8_OPEN : 1, GPIO9_OPEN : 1, GPIO3_fastchg_OT : 1,
                ...
                GPIO8_fastchg_OT : 1, GPIO9_fastchg_OT : 1, EoBtimeerror : 1, CoCouOvF : 1, TrimmCalOk : 1,
                loss_gndref : 1, loss_cgnd : 1, loss_dgnd : 1, loss_agnd : 1, : 14;
        } Frame2;
        struct {
            uint32_t BAL1_OPEN : 1, BAL2_OPEN : 1, BAL3_OPEN : 1, BAL4_OPEN : 1, BAL5_OPEN : 1, BAL6_OPEN : 1,
                BAL7_OPEN : 1, BAL8_OPEN : 1, BAL9_OPEN : 1, BAL10_OPEN : 1, BAL11_OPEN : 1, BAL12_OPEN : 1,
                BAL13_OPEN : 1, BAL14_OPEN : 1, EEPROM_DWNLD_DONE : 1, GPIO3_OPEN : 1, GPIO4_OPEN : 1,
                GPIO5_OPEN : 1, : 14;
        } Frame3;
        struct {
        ...
        struct {
            uint32_t VCELL1_UV : 1, VCELL2_UV : 1, VCELL3_UV : 1, VCELL4_UV : 1, VCELL5_UV : 1, VCELL6_UV : 1,
                VCELL7_UV : 1, VCELL8_UV : 1, VCELL9_UV : 1, VCELL10_UV : 1, VCELL11_UV : 1, VCELL12_UV : 1,
                VCELL13_UV : 1, VCELL14_UV : 1, RAM_CRC_ERR : 1, EEPROM_CRC_ERR_CAL_RAM : 1, Comm_timeout_flt : 1,
                EEPROM_CRC_ERR_SECT_0 : 1, : 14;
        } Frame6;
        struct {
            uint32_t VCELL1_OV : 1, VCELL2_OV : 1, VCELL3_OV : 1, VCELL4_OV : 1, VCELL5_OV : 1, VCELL6_OV : 1,
                VCELL7_OV : 1, VCELL8_OV : 1, VCELL9_OV : 1, VCELL10_OV : 1, VCELL11_OV : 1, VCELL12_OV : 1,
                VCELL13_OV : 1, VCELL14_OV : 1, VSUM_UV : 1, VBATTCRIT_UV : 1, VBATT_WRN_UV : 1, VBATT_WRN_OV : 1, : 14;
        } Frame7;
        struct {
